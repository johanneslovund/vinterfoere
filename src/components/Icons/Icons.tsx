...
export function MicIcon({ size = 18, color = 'currentColor', className = '' }: IconProps) {
  return (
...
export function SatelliteIcon({ size = 16, color = 'currentColor' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
      stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
